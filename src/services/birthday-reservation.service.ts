...
function calculateReservation(extraction: ExtractedBirthdayReservation): BirthdayReservationAnalysis {
  ...
  const customerEmail = extraction.customerEmail ?? "à vérifier"
  ...
  return {
    ...
    totalPrice,
    priceCalculation,
    summary: `anniversaire ${variantName}, téléphone client ${customerPhone}, e-mail client ${customerEmail}, enfant ${childFirstName}, âge ${childAge}, options ${optionsText}, nombre d'enfants ${childrenCount}, prix total CHF ${totalPrice} (${priceCalculation})`,
    confirmationDraft,
    warnings,
    extractionDetails: {
...
Retourne uniquement un JSON STRICT :
{
  ...
  "customerEmail": "adresse e-mail du client ou parent",
